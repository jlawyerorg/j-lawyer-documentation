...
### Kanzleiprofil ausfüllen {#kanzleiprofil}
...
### Datensicherungen konfigurieren {#datensicherung}
...
### Import der deutschen Banken- und Ortschaftenverzeichnisse {#banken-import}

Über das Menü „Datei“ können beide Verzeichnisse importiert werden.

### Ändern des Administratorpasswortes {#admin-passwort}

Über das Menü „Einstellungen“ können Sie die Nutzerverwaltung aufrufen um das Passwort zu ändern.

### Optional: Anlegen zusätzlicher Nutzer {#nutzer-anlegen}
