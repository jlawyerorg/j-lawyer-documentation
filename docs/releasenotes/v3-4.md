...
- Funktion zum Vor- und Zurückspulen
...
- Falldatenblätter lassen sich KI-basierte aus Dokumenten befüllen. Derzeit verfügbar für Verkehrsrecht, Mietrecht und Arbeitsrecht, weitere folgen im Rahmen der regelmäßigen Updates für Falldatenblätter (unabhängig von j-lawyer.org Releases)
...
- HTML-E-Mails: zuletzt genutzte Farben werden gespeichert
...
- neu: Rechnungen zu einer bestimmten Akte (lesen, erstellen)
- neu: Rechnungspositionen zu einer bestimmten Rechnung (lesen, erstellen)
