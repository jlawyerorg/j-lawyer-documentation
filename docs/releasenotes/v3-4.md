# j-lawyer.org 3.4 (Entwicklungsstand 19.12.2025)
...
- Möglichkeit zum Filtern der [Beteiligten](../benutzerhandbuch/aktenverwaltung/beteiligte.md) einer Akte
- Akten suchen anhand des Aktenzeichens Beteiligter (jedoch nicht möglich in Kombination mit Einschränkung via Etiketten)
- **[Aktenhistorien](../benutzerhandbuch/aktenverwaltung/historie.md) lassen sich nun im Browser anzeigen oder als Dokument zur Akte speichern. Es ist ein Filtern und Suchen innerhalb des Exports möglich.**
- **[Falldaten](../benutzerhandbuch/aktenverwaltung/falldaten.md) können nun als Dokument zur Akte gespeichert werden.**
...
- **[Briefkopffunktion](../benutzerhandbuch/dokumentenmanagement/briefkoepfe.md): es können JPG / PNG-Dateien als Briefkopf hinterlegt werden, die bei Erstellung aus Vorlage vollflächig als Hintergrund der ersten Seite eingefügt werden können.**
...
- **Seiten eines [PDF-Dokumentes](../benutzerhandbuch/dokumentenmanagement/pdf.md) lassen sich umsortieren**
- **[Volltextsuche](../benutzerhandbuch/dokumentenmanagement/volltextsuche.md) innerhalb der Akte, samt Highlighting der Suchergebnisse**
...
- **Bei der [Erstellung eines Dokuments aus Vorlage](../benutzerhandbuch/dokumentenmanagement/dokumente-erstellen.md) lässt sich direkt der Zielordner der Akte angeben.**
...
- **[Forderungskonto](../benutzerhandbuch/forderungskonto.md)**: es ist ein Forderungskonto in erster Iteration verfügbar. Es ermöglicht das Erfassen von Haupt- und Nebenforderungen, das Pflegen von Buchungen und Erstellen von Zinsberechnungen sowie das Generieren von Forderungsaufstellungen zur weiteren Veararbeitung.
- **Feature "[Zahlungen](../benutzerhandbuch/zahlungen.md)": ausgehende Zahlungen können nun innerhalb der Akten vorbereitet werden. Vorbereitete Zahlungen können über das Menü "Finanzen" geprüft / freigegeben werden. Anschließend können alle Zahlungen im Stapel in eine oder mehrere SEPA-Dateien exportiert werden, um sie im Onlinebanking zur Ausführung zu bringen.**
- **[Kontoauszug-Import](../benutzerhandbuch/kontoauszugimport.md) kann nun auch geleistete Zahlungen auf erledigt setzen**
...
- **Zeiterfassung nun in separatem Tab "[Zeiten](../benutzerhandbuch/aktenverwaltung/zeiten.md)" der Akten**
...
- **[Falldatenblätter](../benutzerhandbuch/aktenverwaltung/falldaten.md) lassen sich KI-basiert aus Dokumenten befüllen. Derzeit verfügbar für Verkehrsrecht, Mietrecht und Arbeitsrecht, weitere folgen im Rahmen der regelmäßigen Updates für Falldatenblätter (unabhängig von j-lawyer.org Releases)**
...
- **Terminkonflikte werden direkt in der [Akte](../benutzerhandbuch/aktenverwaltung/kalender-akte.md) dargestellt.**
...
- **An/Cc/Bcc einer E-Mail lässt sich nun automatisch ausfüllen. Dazu wurden die [Postvorlagen](../benutzerhandbuch/postvorlagen.md) um die Angaben ergänzt und es können dort Platzhalter für die Mailadresse eingetragen werden.**
...
- **Neue Berechtigung "Systemadministrator": um besser zwischen fachlicher und technischer Verantwortung unterscheiden zu können, wurde die vorhandene "Administrator"-Rolle aufgeteilt in "Unternehmensadmin" und "Systemadmin".** Siehe [Nutzerverwaltung](../benutzerhandbuch/nutzerverwaltung.md).
- **"[App koppeln](../benutzerhandbuch/mobile-app/app-koppeln.md)"-Ansicht im Logindialog. Per QR-Code können die Verbindungseinstellungen in die App auf Smartphone / Tablet übertragen werden. So reduziert sich die Konfiguration auf Eingabe von Nutzer und Passwort.**
